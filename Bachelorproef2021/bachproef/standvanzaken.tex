...
\begin{figure}[!htbp]
    \includegraphics[width=\textwidth]{LanguageDetection.png}
...
Bij het implementeren van het sentiment analysis model, zijn er 3 soorten algoritmes die men kan gebruiken. (MonkeyLearn, 2021)
